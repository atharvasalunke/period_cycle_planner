    ...
    return (
        ...
        >
            <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button
                    type="submit"
                    className="w-full rounded-xl py-6 font-semibold shadow-sm transition-all hover:scale-[1.01]"
                    disabled={isLoading}
                >
            ...
            <Button
                variant="outline"
                className="w-full rounded-xl py-6 border-muted-foreground/20 hover:bg-muted/50 transition-all flex items-center justify-center gap-3"
